...
#catalogo = Catalogo(host='localhost', user='codoacodo', password='1234', database='cryptoworld')
catalogo = Catalogo(host='cryptoworldcodoacodo.mysql.pythonanywhere-services.com',user='cryptoworldcodoa', password='crypto9876', database='cryptoworldcodoa$default')

# Carpeta para guardar las imagenes.
#ruta_destino = './static/imagenes/'
#Al subir al servidor, deberá utilizarse la siguiente ruta. USUARIO debeser reemplazado por el nombre de usuario de Pythonanywhere
ruta_destino = '/home/cryptoworldcodoacodo/mysite/static/imagenes'
#--------------------------------------------------------------------

#--------------------------------------------------------------------
# Listar todos los productos
#--------------------------------------------------------------------
#La ruta Flask /productos con el método HTTP GET está diseñada para proporcionar los detalles de todos los productos almacenados en la base
#de datos.
...
# de que sea seguro para guardar enel sistema de archivos
...
#JSON con un mensaje de error y un código de estado HTTP 500 (Internal Server Error).
...
# Procesamiento de la imagen
    nombre_imagen = secure_filename(imagen.filename) 
#Chequea el nombre del archivo de la imagen, asegurándose de que sea seguro para
...
#se realiza una solicitud DELETE a /productos/ seguido de un número (elcódigo del producto).
